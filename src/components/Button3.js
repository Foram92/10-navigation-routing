...
function Button ({ 
    ...
    return (
        <div>
            {/* here we are not writing onClick={rest.onClick} insteadof {...rest}, bcoz if we write that then that only take one props not other rest props which are we want to use in one single word */}
